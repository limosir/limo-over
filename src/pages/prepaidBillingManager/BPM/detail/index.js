...
class prepaiddetailPage extends Component {
  genExtra = keyValue => (
    <Icon
      type="plus-circle"
      theme="twoTone"
  ...
  render() {
    const { list } = this.props.prepaiddetail;
    const columns = [
      {
        title: '序号',
        visible: true,
...
function mapStateToProps(state) {
  return {
    prepaiddetail: state.prepaiddetail,
    loading: state.loading.models.prepaiddetail,
  };
}
export default connect(mapStateToProps)(prepaiddetail);
